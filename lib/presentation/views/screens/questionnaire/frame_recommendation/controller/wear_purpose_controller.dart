...
class WearPurposeController extends BaseController {
  ...
  String? selectedAge; // Store selectedAge from previous screen
  ...
  void select(int idx) {
    if (selectedIndex.value == idx) {
      ...
      debugPrint('Selected gender option: ${options[idx]} $screenType');
      if (screenType == 'frame') {
        Navigation.navigateToWithArguments(
          ScreenRoutes.scanningFaceScreen,
          arguments: {
            'selectedAge': selectedAge,
            'selectedGender': options[idx],
      ...
      } else if (screenType == 'both' || screenType == SessionParam.BOTH.name) {
        Navigation.navigateToWithArguments(
          ScreenRoutes.minusPowerScreen,
          arguments: {
            'selectedAge': selectedAge,

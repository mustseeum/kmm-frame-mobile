...
class MinusPowerScreen extends BasePage<MinusPowerController> {
  const MinusPowerScreen({super.key});

  @override
  Widget buildPage(BuildContext context) {
    // background color similar to screenshot
    final controller = Get.find<MinusPowerController>();
    final bg = Theme.of(context); // pale teal-ish
    return PopScope(
      canPop: false,
      child: Scaffold(
        backgroundColor: bg.scaffoldBackgroundColor,
        // Top bar with logo on left and "Step 3 of 11" on right
        ...
        child: QuestionHeader(
          ...
          trailing: Padding(
            ...
            child: Text('step_3_of_12'.tr, style: TextStyle(color: Colors.blue)),
          ),
        ),
      ),
      body: Obx(() {

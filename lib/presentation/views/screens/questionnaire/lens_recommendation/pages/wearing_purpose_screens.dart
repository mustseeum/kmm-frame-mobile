...
class WearingPurposeScreens extends BasePage <WearingPurposeController> {
  const WearingPurposeScreens({super.key});
      ...
      appBar: PreferredSize(
        ...
        child: QuestionHeader(
          ...
          trailing: Padding(
            ...
            child: Text('step_6_of_12'.tr, style: TextStyle(color: Colors.blue)),
          ),
        ),
      ),
      body: Obx(() {

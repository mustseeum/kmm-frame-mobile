...
class LightSensitivityScreen extends BasePage <LightSensitivityController>{
  const LightSensitivityScreen({super.key});

  @override
  Widget buildPage(BuildContext context) {
    final controller = Get.find<LightSensitivityController>();
      ...
      child: Scaffold(
        ...
        child: QuestionHeader(
          ...
          trailing: Padding(
            ...
            child: Text('step_10_of_12'.tr, style: TextStyle(color: Colors.blue)),
          ),
        ),
      ),
      body: Obx(() {

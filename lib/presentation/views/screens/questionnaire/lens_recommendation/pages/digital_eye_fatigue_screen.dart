...
class DigitalEyeFatigueScreen extends BasePage<DigitalEyeFatigueController> {
  const DigitalEyeFatigueScreen({super.key});

  @override
  Widget buildPage(BuildContext context) {
    // background color similar to screenshot
    final controller = Get.find<DigitalEyeFatigueController>();
      ...
      child: Scaffold(
        ...
        child: QuestionHeader(
          ...
          trailing: Padding(
            ...
            child: Text('step_8_of_12'.tr, style: TextStyle(color: Colors.blue)),
          ),
        ),
      ),
      body: Obx(() {

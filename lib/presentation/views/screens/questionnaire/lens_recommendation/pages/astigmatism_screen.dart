...
class AstigmatismScreen extends BasePage<AstigmatismController> {
  const AstigmatismScreen({super.key});
      ...
      appBar: PreferredSize(
        ...
        child: QuestionHeader(
          ...
          trailing: Padding(
            ...
            child: Text('step_5_of_12'.tr, style: TextStyle(color: Colors.blue)),
          ),
        ),
      ),
      body: Obx(() {

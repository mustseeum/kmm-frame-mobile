...
class ImportantDistanceScreen extends BasePage<ImportantDistanceController> {
  const ImportantDistanceScreen({super.key});

  @override
  Widget buildPage(BuildContext context) {
    // background color similar to screenshot
    final bg = Theme.of(context); // pale teal-ish
    final controller = Get.find<ImportantDistanceController>();
    return Scaffold(
      backgroundColor: bg.scaffoldBackgroundColor,
      // Top bar with logo on left and "Step 7 of 11" on right
      appBar: PreferredSize(
        ...
        child: QuestionHeader(
          ...
          trailing: Padding(
            ...
            child: Text('step_7_of_12'.tr, style: TextStyle(color: Colors.blue)),
          ),
        ),
      ),
      body: Obx(() {

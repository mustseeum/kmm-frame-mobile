...
class BudgetPreferenceController extends BaseController {
  ...
  Future<void> _loadQuestionData() async {
    try {
      ...
      ageQuestion = questionData?.firstWhere((q) => q?.id == 'budget_preference');
  ...
  void select(int idx) {
    if (selectedIndex.value == idx) {
      ...
      // Navigation.navigateToWithArguments(ScreenRoutes.scanResultScreen, arguments: {

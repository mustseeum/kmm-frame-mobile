...
class MinusPowerController extends BaseController {
  ...
  Future<void> _loadQuestionData() async {
    try {
      ...
      ageQuestion = questionData?.firstWhere((q) => q?.id == 'minus_power');
  ...
  void select(int idx) {
    if (selectedIndex.value == idx) {
      ...
      Navigation.navigateToWithArguments(ScreenRoutes.plusPowerScreen, arguments: {

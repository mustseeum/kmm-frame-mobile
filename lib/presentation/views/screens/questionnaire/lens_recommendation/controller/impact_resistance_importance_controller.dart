...
class ImpactResistanceImportanceController extends BaseController {
  ...
  Future<void> _loadQuestionData() async {
    try {
      ...
      ageQuestion = questionData?.firstWhere((q) => q?.id == 'impact_resistance_importance');
  ...
  void select(int idx) {
    if (selectedIndex.value == idx) {
      ...
      Navigation.navigateToWithArguments(ScreenRoutes.budgetPreferenceScreen, arguments: {

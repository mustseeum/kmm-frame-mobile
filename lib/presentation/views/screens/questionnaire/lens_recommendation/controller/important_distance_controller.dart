...
class ImportantDistanceController extends BaseController {
  ...
  Future<void> _loadQuestionData() async {
    try {
      ...
      ageQuestion = questionData?.firstWhere((q) => q?.id == 'important_distance');
  ...
  void select(int idx) {
    if (selectedIndex.value == idx) {
      ...
      Navigation.navigateToWithArguments(ScreenRoutes.digitalEyeFatigueScreen, arguments: {

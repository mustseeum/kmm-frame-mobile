...
class WearingPurposeController extends BaseController {
  ...
  void select(int idx) {
    if (selectedIndex.value == idx) {
      ...
      Navigation.navigateToWithArguments(ScreenRoutes.importantDistanceScreen, arguments: {

...
class DigitalEyeFatigueController extends BaseController {
  ...
  Future<void> _loadQuestionData() async {
    try {
      ...
      ageQuestion = questionData?.firstWhere((q) => q?.id == 'digital_eye_fatigue');
  ...
  void select(int idx) {
    if (selectedIndex.value == idx) {
      ...
      Navigation.navigateToWithArguments(ScreenRoutes.uvProtectionImportanceScreen, arguments: {

                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Obx(
                            () => HeadingCardWidget(
                              containerWidth:
                                  GlobalFunctionHelper.getContainerWidth(
                                    constraints,
                                  ),
                              isDevelopmentEndpoint:
                                  auth.isDevelopmentEndpoint.value,
                              isTablet: GlobalFunctionHelper.isTablet(
                                constraints,
                              ),
                              onEndpointChanged: (bool isDevelopment) {
                                auth.switchEndpoint(isDevelopment);
                              },
                            ),
                          ),
                          ...
                          Container(
                            ...
                            padding: EdgeInsets.all(
                              GlobalFunctionHelper.isTablet(constraints)
                                  ? 36
                                  : 20,
                            ),
                          ...
                          Center(
                            child: Padding(
                              padding: EdgeInsets.only(
                                top: GlobalFunctionHelper.isTablet(constraints)
                                    ? 24
                                    : 12,
                              ),
                              child: Text(

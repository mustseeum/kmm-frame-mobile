              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.all(FunctionHelper.isTablet(constraints) ? 36 : 20),
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Login'.tr,
                          style: TextStyle(
                            fontSize: FunctionHelper.isTablet(constraints) ? 32 : 18,
                        ...
                        Text(
                          'login_wording'.tr,
                          style: TextStyle(
                            fontSize: FunctionHelper.isTablet(constraints) ? 16 : 18,
                  ...
                  Center(
                    child: Padding(
                      padding: EdgeInsets.only(top: FunctionHelper.isTablet(constraints) ? 24 : 12),
                      child: Text(
                        'copy_right'.tr,
                        style: TextStyle(
                          fontSize: FunctionHelper.isTablet(constraints) ? 14 : 12,
                          color: AppColors.colorText,
                          fontWeight: FontWeight.w600
                        ),
                      ),

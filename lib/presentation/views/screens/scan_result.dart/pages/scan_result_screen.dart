            ...
            child: Column(
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Color(0xFF06293D)),
                ),
                const SizedBox(height: 18),
                              ...
                              children: [
                                ...
                                ProfileCard(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Expanded(child: InfoTile(label: 'face_width'.tr, value: _mm(profile?.faceWidth))),
                                        const SizedBox(width: 12),
                                        Expanded(child: InfoTile(label: 'eye_length'.tr, value: _mm(profile?.eyeLength))),
                                      ],
                                    ),
                                    Row(
                                      children: [
                                        Expanded(child: InfoTile(label: 'eye_width'.tr, value: _mm(profile?.eyeWidth))),
                                        const SizedBox(width: 12),
                                        Expanded(child: InfoTile(label: 'eye_height'.tr, value: _mm(profile?.eyeHeight))),
                                      ],
                                    ),
                                    Row(
                                      children: [
                                        Expanded(child: InfoTile(label: 'bridge'.tr, value: _mm(profile?.bridge))),
                                        const SizedBox(width: 12),
                                        Expanded(child: InfoTile(label: 'temple_length'.tr, value: _mm(profile?.templeLength))),
                                      ],
                                    ),
                                  ],
                                ),
                                ...
                                ProfileCard(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Expanded(child: InfoTile(label: 'frame'.tr, value: profile?.suggestedFrame ?? '-')),
                                        const SizedBox(width: 12),
                                        Expanded(child: InfoTile(label: 'color'.tr, value: profile?.suggestedColor ?? '-')),
                                      ],
                                    ),
                                  ],
                                ),
                                    ...
                                    Expanded(
                                      child: OutlinedButton.icon(
                                        ...
                                        label: Padding(
                                          ...
                                          child: Text('retake_scan'.tr, style: const TextStyle(fontWeight: FontWeight.w600)),
                                        ),
                                    ...
                                    Expanded(
                                      child: ElevatedButton(
                                        ...
                                        child: Obx(() {
                                          ...
                                          return Text('try_on_myself'.tr, style: const TextStyle(fontWeight: FontWeight.bold));
                                        }),
                                      ),
                                    ),
                                  ],

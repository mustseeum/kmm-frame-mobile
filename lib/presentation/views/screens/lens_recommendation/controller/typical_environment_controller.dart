...
class TypicalEnvironmentController extends BaseController {
  ...
  Future<void> _loadQuestionData() async {
    try {
      ...
      // Find the typical_environment question
      ageQuestion = questionData?.firstWhere((q) => q?.id == 'typical_environment');
